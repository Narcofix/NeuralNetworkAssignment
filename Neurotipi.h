...
typedef struct SINAPSI{
  ...
  struct SINAPSI *next;          /*puntatore al prossimo arco uscente dal neurone nella lista*/
}Sinapsi,*SinapsiLink;

typedef struct BACKLINK{         /*str.dati utilizzata per la backpropagation(ricorda i neuroni precedenti)*/
...
typedef struct NEURONE{
  ...
  SinapsiLink			  next;          /*puntatore alla lista di sinapsi che vanno negli altri neuroni*/
  SinapsiLink			  coda;          /*puntatore alla coda della lista di sinapsi*/
  BackLinks				   inn;           /*puntatore alla lista dei neuroni precedenti(per la backpropagation)*/
...
typedef struct STRATO{           /*struttura che rappresenta un singolo strato del percettrone*/
...
int      dim_out;																/*dimensione di output calcolata in base alla struttura dei patern*/
