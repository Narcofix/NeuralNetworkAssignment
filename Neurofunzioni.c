...
Rete CreaArchitettura_file(Retestr struttura, int no_pesi) {
  ...
  if (no_pesi) {
    /*creo le sinapsi con i valori casuali poich� assenti da file*/
...
Rete CreaArchitettura_default(Retetrg struttura2) {
  ...
  if (struttura2->dim_out == 1)
    dim_out = 2;
  else
    dim_out = struttura2->dim_out;
  if (struttura2->dim[0] == 1)
    dim_out1 = 2;
  else
    dim_out1 = struttura2->dim[0];
...
/*funzione che verifica se esiste un determinato neurone nell' insieme di
 * output*/
...
/*funzione che crea la maglia di sinapsi tra i neuroni di input e quelli di
 * output*/
/*(per il momento tutti i neuroni di input vengono collegati con quelli di
 * output*/
...
void CreaSinapsi_file(Strato neuroStr1, Strato neuroStr2,
                      tipopesoSinapsi *pesi) {
  int i, j;
  /*assegno i pesi dallo strato i allo strato i+1*/
  for (i = 0; i < neuroStr1->num_neuro_el; i++) {
    for (j = 0; j < neuroStr2->num_neuro_el; j++) {
      Insertsinapsi(neuroStr1, neuroStr2, i, j,
                    pesi[(i * neuroStr2->num_neuro_el) + j]);
    }
  }
...
Rete Crea_Architettura_CERCHI() {
  ...
  for (k = 0; k < 2; k++) {
    for (i = 0; i < 2; i++) {
      for (j = 0; j < 8; j++) {
        /*funzione che crea una sinapsi sul neurone Ni che va nel neurone Nj*/
        Insertsinapsi(R->ptr_str[0], R->ptr_str[1],
                      (j * 16) + (i * 8) + (k * 128), i + 2 * k, casual());
        Insertsinapsi(R->ptr_str[0], R->ptr_str[1],
                      1 + (j * 16) + (i * 8) + (k * 128), i + 2 * k, casual());
        Insertsinapsi(R->ptr_str[0], R->ptr_str[1],
                      2 + (j * 16) + (i * 8) + (k * 128), i + 2 * k, casual());
        Insertsinapsi(R->ptr_str[0], R->ptr_str[1],
                      3 + (j * 16) + (i * 8) + (k * 128), i + 2 * k, casual());
        Insertsinapsi(R->ptr_str[0], R->ptr_str[1],
                      4 + (j * 16) + (i * 8) + (k * 128), i + 2 * k, casual());
        Insertsinapsi(R->ptr_str[0], R->ptr_str[1],
                      5 + (j * 16) + (i * 8) + (k * 128), i + 2 * k, casual());
        Insertsinapsi(R->ptr_str[0], R->ptr_str[1],
                      6 + (j * 16) + (i * 8) + (k * 128), i + 2 * k, casual());
        Insertsinapsi(R->ptr_str[0], R->ptr_str[1],
                      7 + (j * 16) + (i * 8) + (k * 128), i + 2 * k, casual());
      }
    }
  }
  ...
  for (k = 0; k < 4; k++) {
    for (i = 0; i < 4; i++) {
      for (j = 0; j < 4; j++) {
        /*funzione che crea una sinapsi sul neurone Ni che va nel neurone Nj*/
        Insertsinapsi(R->ptr_str[0], R->ptr_str[1],
                      (j * 16) + (i * 4) + (k * 64), i + 4 * k + 4, casual());
        Insertsinapsi(R->ptr_str[0], R->ptr_str[1],
                      1 + (j * 16) + (i * 4) + (k * 64), i + 4 * k + 4,
                      casual());
        Insertsinapsi(R->ptr_str[0], R->ptr_str[1],
                      2 + (j * 16) + (i * 4) + (k * 64), i + 4 * k + 4,
                      casual());
        Insertsinapsi(R->ptr_str[0], R->ptr_str[1],
                      3 + (j * 16) + (i * 4) + (k * 64), i + 4 * k + 4,
                      casual());
      }
    }
  }
  ...
  for (i = 0; i < 4; i++) {
    for (j = 0; j < 4; j++) {
      /*funzione che crea una sinapsi sul neurone Ni che va nel neurone Nj*/
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], ((j + (i * 4)) * 16), i + 20,
                    casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 1 + ((j + (i * 4)) * 16),
                    i + 20, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 2 + ((j + (i * 4)) * 16),
                    i + 20, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 3 + ((j + (i * 4)) * 16),
                    i + 20, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 4 + ((j + (i * 4)) * 16),
                    i + 20, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 5 + ((j + (i * 4)) * 16),
                    i + 20, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 6 + ((j + (i * 4)) * 16),
                    i + 20, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 7 + ((j + (i * 4)) * 16),
                    i + 20, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 8 + ((j + (i * 4)) * 16),
                    i + 20, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 9 + ((j + (i * 4)) * 16),
                    i + 20, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 10 + ((j + (i * 4)) * 16),
                    i + 20, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 11 + ((j + (i * 4)) * 16),
                    i + 20, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 12 + ((j + (i * 4)) * 16),
                    i + 20, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 13 + ((j + (i * 4)) * 16),
                    i + 20, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 14 + ((j + (i * 4)) * 16),
                    i + 20, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 15 + ((j + (i * 4)) * 16),
                    i + 20, casual());
    }
  }
  ...
  for (i = 0; i < 4; i++) {
    for (j = 0; j < 16; j++) {
      /*funzione che crea una sinapsi sul neurone Ni che va nel neurone Nj*/
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], (i * 4) + (j * 16), i + 24,
                    casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 1 + (i * 4) + (j * 16),
                    i + 24, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 2 + (i * 4) + (j * 16),
                    i + 24, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 3 + (i * 4) + (j * 16),
                    i + 24, casual());
    }
  }
  ...
  for (k = 0; k < 8; k++) {
    for (i = 0; i < 8; i++) {
      for (j = 0; j < 2; j++) {
        Insertsinapsi(R->ptr_str[0], R->ptr_str[1],
                      (j * 16) + (i * 2) + (k * 32), i + 8 * k + 28, casual());
        Insertsinapsi(R->ptr_str[0], R->ptr_str[1],
                      1 + (j * 16) + (i * 2) + (k * 32), i + 8 * k + 28,
                      casual());
      }
    }
  }
  ...
  */
  ...
  for (i = 0; i < 8; i++) {
    for (j = 0; j < 16; j++) {
      /*funzione che crea una sinapsi sul neurone Ni che va nel neurone Nj*/
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], (i * 2) + (j * 16), i + 92,
                    casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 1 + (i * 2) + (j * 16),
                    i + 92, casual());
    }
  }
  ...
  for (i = 0; i < 8; i++) {
    for (j = 0; j < 2; j++) {
      /*funzione che crea una sinapsi sul neurone Ni che va nel neurone Nj*/
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], ((j + (i * 2)) * 16), i + 100,
                    casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 1 + ((j + (i * 2)) * 16),
                    i + 100, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 2 + ((j + (i * 2)) * 16),
                    i + 100, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 3 + ((j + (i * 2)) * 16),
                    i + 100, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 4 + ((j + (i * 2)) * 16),
                    i + 100, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 5 + ((j + (i * 2)) * 16),
                    i + 100, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 6 + ((j + (i * 2)) * 16),
                    i + 100, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 7 + ((j + (i * 2)) * 16),
                    i + 100, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 8 + ((j + (i * 2)) * 16),
                    i + 100, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 9 + ((j + (i * 2)) * 16),
                    i + 100, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 10 + ((j + (i * 2)) * 16),
                    i + 100, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 11 + ((j + (i * 2)) * 16),
                    i + 100, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 12 + ((j + (i * 2)) * 16),
                    i + 100, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 13 + ((j + (i * 2)) * 16),
                    i + 100, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 14 + ((j + (i * 2)) * 16),
                    i + 100, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 15 + ((j + (i * 2)) * 16),
                    i + 100, casual());
    }
  }
  ...
  for (k = 0; k < 2; k++) {
    for (i = 0; i < 1; i++) {
      for (j = 0; j < 8; j++) {
        /*funzione che crea una sinapsi sul neurone Ni che va nel neurone Nj*/
        Insertsinapsi(R->ptr_str[0], R->ptr_str[1],
                      (j * 16) + (i * 8) + (k * 128) + 4, i + 2 * k + 108,
                      casual());
        Insertsinapsi(R->ptr_str[0], R->ptr_str[1],
                      1 + (j * 16) + (i * 8) + (k * 128) + 4, i + 2 * k + 108,
                      casual());
        Insertsinapsi(R->ptr_str[0], R->ptr_str[1],
                      2 + (j * 16) + (i * 8) + (k * 128) + 4, i + 2 * k + 108,
                      casual());
        Insertsinapsi(R->ptr_str[0], R->ptr_str[1],
                      3 + (j * 16) + (i * 8) + (k * 128) + 4, i + 2 * k + 108,
                      casual());
        Insertsinapsi(R->ptr_str[0], R->ptr_str[1],
                      4 + (j * 16) + (i * 8) + (k * 128) + 4, i + 2 * k + 108,
                      casual());
        Insertsinapsi(R->ptr_str[0], R->ptr_str[1],
                      5 + (j * 16) + (i * 8) + (k * 128) + 4, i + 2 * k + 108,
                      casual());
        Insertsinapsi(R->ptr_str[0], R->ptr_str[1],
                      6 + (j * 16) + (i * 8) + (k * 128) + 4, i + 2 * k + 108,
                      casual());
        Insertsinapsi(R->ptr_str[0], R->ptr_str[1],
                      7 + (j * 16) + (i * 8) + (k * 128) + 4, i + 2 * k + 108,
                      casual());
      }
    }
  }
  ...
  for (k = 0; k < 4; k++) {
    for (i = 0; i < 3; i++) {
      for (j = 0; j < 4; j++) {
        /*funzione che crea una sinapsi sul neurone Ni che va nel neurone Nj*/
        Insertsinapsi(R->ptr_str[0], R->ptr_str[1],
                      (j * 16) + (i * 4) + (k * 64) + 2, i + 4 * k + 110,
                      casual());
        Insertsinapsi(R->ptr_str[0], R->ptr_str[1],
                      1 + (j * 16) + (i * 4) + (k * 64) + 2, i + 4 * k + 110,
                      casual());
        Insertsinapsi(R->ptr_str[0], R->ptr_str[1],
                      2 + (j * 16) + (i * 4) + (k * 64) + 2, i + 4 * k + 110,
                      casual());
        Insertsinapsi(R->ptr_str[0], R->ptr_str[1],
                      3 + (j * 16) + (i * 4) + (k * 64) + 2, i + 4 * k + 110,
                      casual());
      }
    }
  }
  ...
  for (i = 0; i < 3; i++) {
    for (j = 0; j < 4; j++) {
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], ((j + 2 + (i * 4)) * 16),
                    i + 122, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 1 + ((j + 2 + (i * 4)) * 16),
                    i + 122, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 2 + ((j + 2 + (i * 4)) * 16),
                    i + 122, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 3 + ((j + 2 + (i * 4)) * 16),
                    i + 122, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 4 + ((j + 2 + (i * 4)) * 16),
                    i + 122, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 5 + ((j + 2 + (i * 4)) * 16),
                    i + 122, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 6 + ((j + 2 + (i * 4)) * 16),
                    i + 122, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 7 + ((j + 2 + (i * 4)) * 16),
                    i + 122, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 8 + ((j + 2 + (i * 4)) * 16),
                    i + 122, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 9 + ((j + 2 + (i * 4)) * 16),
                    i + 122, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 10 + ((j + 2 + (i * 4)) * 16),
                    i + 122, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 11 + ((j + 2 + (i * 4)) * 16),
                    i + 122, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 12 + ((j + 2 + (i * 4)) * 16),
                    i + 122, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 13 + ((j + 2 + (i * 4)) * 16),
                    i + 122, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 14 + ((j + 2 + (i * 4)) * 16),
                    i + 122, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 15 + ((j + 2 + (i * 4)) * 16),
                    i + 122, casual());
    }
  }
  ...
  for (i = 0; i < 3; i++) {
    for (j = 0; j < 16; j++) {
      /*funzione che crea una sinapsi sul neurone Ni che va nel neurone Nj*/
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], (i * 4) + (j * 16) + 2,
                    i + 125, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 1 + (i * 4) + (j * 16) + 2,
                    i + 125, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 2 + (i * 4) + (j * 16) + 2,
                    i + 125, casual());
      Insertsinapsi(R->ptr_str[0], R->ptr_str[1], 3 + (i * 4) + (j * 16) + 2,
                    i + 125, casual());
    }
  }
...
void propagavals(Rete R) {
  ...
  for (j = 1; j < R->nstrati; j++) {
    for (i = 0; i < R->ptr_str[j]->num_neuro_el; i++) {
      ...
      max_val_x = 150 / 0.5;
      if (R->ptr_str[j]->neuro_el[i].val_x > max_val_x)
        R->ptr_str[j]->neuro_el[i].val_x = max_val_x;
      else if (R->ptr_str[j]->neuro_el[i].val_x < -max_val_x)
        R->ptr_str[j]->neuro_el[i].val_x = -max_val_x;
      R->ptr_str[j]->neuro_el[i].soglia =
          sigm_uni(R->ptr_str[j]->neuro_el[i].val_x);
    }
    // for(j=1;j<R->nstrati;j++){
    // k=0;
    //	mod2=5;
...
unsigned __stdcall potential_T(void *pmydata) {
  ...
  local->R->ptr_str[j]->neuro_el[i].soglia =
      sigm_uni(out_val + local->R->ptr_str[j]->neuro_el[i].bias);
  return 0;
}
...
void delta_outs(Rete R, Retetrg struttura2, int occ) {
  ...
  for (i = 0; i < R->ptr_str[R->nstrati - 1]->num_neuro_el; i++) {
    R->ptr_str[R->nstrati - 1]->neuro_el[i].E =
        delta_out(R->ptr_str[R->nstrati - 1]->neuro_el[i].soglia,
                  struttura2->vals[occ][(struttura2->dim[0]) + i]);
  }
}
...
void propagaerrors(Rete R) {
  ...
  for (i = (R->nstrati - 2); i > 0; i--) {
    for (j = 0; j < R->ptr_str[i]->num_neuro_el; j++) {
      ...
      R->ptr_str[i]->neuro_el[j].E =
          derivata_sigm(R->ptr_str[i]->neuro_el[j].soglia) * sum;
    }
  }
}
...
void updategradients(Rete R) {
  ...
  for (i = 1; i < R->nstrati; i++) {
    for (j = 0; j < R->ptr_str[i]->num_neuro_el; j++) {
      ...
      R->ptr_str[i]->neuro_el[j].bias_D +=
          R->ptr_str[i]
              ->neuro_el[j]
              .E;  // si presuppone che il bias ha soglia uno
    }
  }
}
  ...
  for (i = 1; i < R->nstrati; i++) {
    for (j = 0; j < R->ptr_str[i]->num_neuro_el; j++) {
      ...
      while (ptr2 != NULL) {  // sommatoria produttorie
        ...
        if (grad > 0.0) {
          ptr2->back->delta =
              min(ptr2->back->delta * R->Fapp_pos, R->delta_Fapp_max);
        } else if (grad < 0.0) {
          ptr2->back->delta =
              max(ptr2->back->delta * R->Fapp_neg, R->delta_Fapp_min);
          ptr2->back->D = 0.0;
        } else {
          ptr2->back->delta = 0.0;
        }
        if (ptr2->back->D < 0.0)
          ptr2->back->W -= ptr2->back->delta;
        else
          ptr2->back->W += ptr2->back->delta;
      ...
      R->ptr_str[i]->neuro_el[j].bias_delta =
          max(R->ptr_str[i]->neuro_el[j].bias_delta, (tipoNeurone)0.001);
      grad = R->ptr_str[i]->neuro_el[j].bias_D *
             R->ptr_str[i]->neuro_el[j].bias_precD;
      if (grad > 0.0) {
        R->ptr_str[i]->neuro_el[j].bias_delta =
            min(R->ptr_str[i]->neuro_el[j].bias_delta * R->Fapp_pos,
                R->delta_Fapp_max);
      } else if (grad < 0.0) {
        R->ptr_str[i]->neuro_el[j].bias_delta =
            max(R->ptr_str[i]->neuro_el[j].bias_delta * R->Fapp_neg,
                R->delta_Fapp_min);
        R->ptr_str[i]->neuro_el[j].bias_D = 0.0;
      } else {
        R->ptr_str[i]->neuro_el[j].bias_delta = 0.0;
      }
      if (R->ptr_str[i]->neuro_el[j].bias_D < 0)
        R->ptr_str[i]->neuro_el[j].bias -=
            R->ptr_str[i]->neuro_el[j].bias_delta;
      else
        R->ptr_str[i]->neuro_el[j].bias +=
            R->ptr_str[i]->neuro_el[j].bias_delta;
...
tipoNeurone **funzionamento(Rete R, Retestr struttura, Retetrg struttura2) {
  ...
  for (k = 0; k < struttura2->npatt; k++) {
    ...
    struttura2->mse += err_quad(R->ptr_str[R->nstrati - 1], struttura2->vals[k],
                                struttura2->dim[0]);
  }
